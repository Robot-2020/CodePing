...
// The simplified runtime only uses hook-driven agents, so there are no
// background log monitors to start or stop when agent flags change.
function startMonitorForAgent(_agentId) {}
function stopMonitorForAgent(_agentId) {}
...
const { showPermissionBubble, resolvePermissionEntry, sendPermissionResponse, repositionBubbles, permLog, PASSTHROUGH_TOOLS, syncPermissionShortcuts, replyOpencodePermission } = _perm;
